    ...
    <div class="c4">
        <div class="c2">
            ...
            <ul>
                ...
                <li>
                    Warlocks can use daggers, one-handed swords, staves, and wands.
                </li>
                <li>
                    Mastery: Chaotic Energies: Your spells deal a random amount of additional damage, up to %. Damage you take is reduced by a random amount, up to %.
                </li>
                <li>Special Class Hall Rewards - Still obtainable in Battle for Azeroth
                    <ul>
                        <li>Mount: Netherlord's Chaotic Wrathsteed
                        </li>
                        <li>Unlockable by Power Ascended: Hellblazing Reins of the Brimstone Wrathsteed
                        </li>
                        <li>Pet: Hateful Eye (Requires Demonic Offering)
                        </li>
                        <li>Title: Netherlord %s
                        </li>
                    </ul>
                </li>
                <li>Warlocks are on the Conqueror Tier Token, sharing tier tokens with
                    <ul>
                        <li>Demon Hunter</li>
                        <li>Paladin</li>
                        <li>Priest</li>
            ...
            <ol>
                ...
                <li>Cinders of the Azj'Aqir</li>
            </ol>
            <p>For raiding, if you craft Relic of Demonic Synergy you're ready for every single encounter, as this is the strongest bonus on more or less every fight.
            </p>
            <p>Secondly you should craft Wilfred's Sigil of Superior Summoning which can also be very strong on fights where you're able to get more Summon Infernal due to a high amount of Soul Shards spent. This can be ideal for a fight such as the Stone
                Legion Generals in Castle Nathria where you constantly have more adds spawn, allowing you to generate and spend more shards.
            </p>
            ...
            <p>If you're looking to do big damage in Mythic+, you will want Wilfred's Sigil of Superior Summoning as your #1 priority! Overall this bonus is strong, but it shines in dungeons where you're able to generate and spend a lot of Soul Shards, thus
