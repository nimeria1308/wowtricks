<div class="dropdown">
    <div class="dropdown_button">
        <div class="menu_link">Classes</div>
    </div>
...
<div class="dropdown">
    <div class="dropdown_button">
        <div class="menu_link">Covenants</div>
    </div>
    <div class="dropdown_content">
        <nav class="menu_item">
            <ul>
...
<div class="dropdown">
    <div class="dropdown_button">
        <div class="menu_link">Dungeons</div>
    </div>
    <div class="dropdown_content">
        <nav class="menu_item">
            <ul>
                <li class="inactive">De Other Side</li>
                <li class="inactive">Halls of Atonement</li>
                <li class="inactive">Mists of Tirna Scithe</li>
                <li class="inactive">The Necrotic Wake</li>
                <li class="inactive">Plaguefall</li>
                <li class="inactive">Sanguine Depths</li>
                <li class="inactive">Spires of Ascention</li>
                <li class="inactive">Theatre of Pain</li>
            </ul>
        </nav>
    </div>
</div>